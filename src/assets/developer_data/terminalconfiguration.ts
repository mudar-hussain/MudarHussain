const TerminalConfiguration = {
  ...
  commands: {
    ...
    skills: {
      frontend: 'HTML, CSS, React, Material UI, Styled component, Tailwind',
    ...
    projects: {
      JobLeet:
        'Full stack recruitment agency software for Job seekers, Employers and Recruiters',
      MessageQueue: 'Distributed Message queuing protocol from scratch',
    },
    publications: {
      image_caption:
        'Image Captioning with Audio reinforcement using RNN and CNN',
    ...
    contact: {
      email: 'work.nishantbanjade@gmail.com',
    },
  },
};
